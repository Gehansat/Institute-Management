...
export default function AcceptedRegPayments(){
    ...
    useEffect(()=>{
        function getPayments(){
            axios.get("http://localhost:8070/registrationPayments/displayAccepted/").then((res)=>{
...
function updateSearchTerms (newSearchTerm){
    function getSearchedPayments(){
        axios.get(`http://localhost:8070/registrationPayments/displayAcceptedSearch/${newSearchTerm}`).then((res)=>{
            setPayments(res.data);
    ...
    return(
        <div>
            ...
            <div className="container">
                <h2 style={{textAlign: "center", margin:"20px"}}>Accepted Registration Payments</h2>
